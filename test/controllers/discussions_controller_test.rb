...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { question: @discussion.question, title: @discussion.title, user_id: @discussion.user_id } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { question: @discussion.question, title: @discussion.title, user_id: @discussion.user_id } }
